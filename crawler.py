...
class Crawler(Thread):
    def _init_(self, base_url, links_to_crawl, have_visited, error_links, url_lock):
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                ...
                print(
                    f"URL {link} threw this error {e.reason} while trying to parse")
...
for i in range(int(number_of_threads)):
    crawler = Crawler(base_url = baseURL, 
